import { BuiltInPowerupCodes, PORTAL_TYPE, PropertyType, RemId, RemType, RichTextInterface, SearchPortalQuery, SetRemType, SlotCodesForPowerup } from '../interfaces';
...
export declare class Rem {
     ...
     */
    readonly children: RemId[] | undefined;
    /**
     ...
     */
    setTableFilter: (filter: SearchPortalQuery) => Promise<void>;
    /**
     * Check if a Rem is a table rem.
     */
    isTable: () => Promise<any>;
    ...
    /**
     * Get the powerup property for this Rem's `powerupCode`'s `powerupSlot`.
     * @return The Rem storing the property
     */
    getPowerupPropertyAsRem: <PowerupCode extends BuiltInPowerupCodes>(powerupCode: string | PowerupCode, powerupSlot: string | keyof {
        ha: {};
        l: {
            Aliases: string;
        };
        ...
        id: {};
        sd: {};
    }[PowerupCode]) => Promise<Rem | undefined>;
    getTagPropertyAsRem: (propertyId: RemId) => Promise<Rem | undefined>;
    /**
     * Get the powerup property for this Rem's `powerupCode`'s `powerupSlot`.
    ...
    getTagPropertyValue: (propertyId: RemId) => Promise<RichTextInterface>;
    getPropertyType: () => Promise<PropertyType | undefined>;
    ...
    /**
     * Returns true if this Rem is a Quote.
     */
    isQuote: () => Promise<boolean>;
    /**
     * Set whether or not this Rem is a Quote.
     */
    setIsQuote: (isQuote: boolean) => Promise<void>;
    /**
     * Returns true if this Rem is a Code Block.
     */
    isCode: () => Promise<boolean>;
    /**
     * Set whether or not this Rem is a Code Block.
     */
    ...
    /**
     * Get the Rem's font size if it is a heading. Returns undefined for normal text.
     */
     ...
     * @deprecated Use `setIsProperty` instead.
     */
    setIsSlot: (isSlot: boolean) => Promise<void>;
    /**
     * Returns whether or not this Rem is a property.
     */
    isProperty: () => Promise<boolean>;
    /**
     * Set whether or not this Rem is a property.
     */
    setIsProperty: (isProperty: boolean) => Promise<void>;
    ...
    /**
     * Scroll the highlight this Rem represents into view in the PDF/HTML reader.
     */
 ...
 */
export declare class RemNamespace extends NamespaceBase {
    /** @hidden */
    ...
    /**
     * Creates a single Rem representing your parsed `markdown`.
     * Newlines will NOT be turned into separate sibling/child Rem.
     */
    createSingleRemWithMarkdown: (markdown: string, parentId?: RemId) => Promise<Rem | undefined>;
    /**
     * Creates a tree of Rem representing your parsed `markdown`.
     * Newlines will be turned into separate sibling/child Rem.
     */
    createTreeWithMarkdown: (markdown: string, parentId?: RemId) => Promise<Rem[]>;
    /**
    ...
    /**
     * Create a Rem that represents an external web link.
     * For example, you can create a link Rem to http://google.com/.
     * Clicking this link in the editor will open the URL in a separate tab.
     * If a Rem for this link already exists, it will be returned.
     * If addTitle is true, the title of the page will be used as the name of the Rem.
     */
    createLinkRem: (url: string, addTitle?: boolean) => Promise<Rem | undefined>;
    /**
     * Create a Table Rem.
     */
    createTable: (existingTag?: RemId | Rem) => Promise<Rem | undefined>;
