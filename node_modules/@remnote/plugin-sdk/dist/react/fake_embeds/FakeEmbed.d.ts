...
export interface PluginDocumentViewProps extends ComponentDimensionsProps {
    documentId: RemId;
}
export interface PDFWebReaderProps extends ComponentDimensionsProps {
    remId: RemId | undefined;
    /**
     * True if you initially want to show only the reader and not the editor.
     * The user can still press the button to open the editor.
     */
    initOnlyShowReader?: boolean;
}
export declare class PDFWebReader extends React.Component<PDFWebReaderProps> {
    render(): JSX.Element;
}
export declare class DocumentViewer extends React.Component<PluginDocumentViewProps> {
    render(): JSX.Element;
}
/**
