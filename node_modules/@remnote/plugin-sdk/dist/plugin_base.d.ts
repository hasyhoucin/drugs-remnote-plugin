...
import { KnowledgeBaseNamespace } from './name_spaces/knowledge_base';
import { SchedulerNamespace } from './name_spaces/scheduler';
import { QueueNamespace } from './name_spaces/queue';
import { Query } from './name_spaces/query';
import { ReaderNamespace } from './name_spaces/reader';
export { AppNamespace };
export { RemNamespace };
...
export { SchedulerNamespace };
export { KnowledgeBaseNamespace };
export { QueueNamespace };
export { Query };
export { ReaderNamespace };
/**
...
export declare abstract class RNPlugin {
    ...
    private setDarkMode;
    /** @hidden */
    setCustomCSS({ cssBlocks, cssUrls }: {
        cssBlocks: [];
        cssUrls: [];
    }): void;
    /**
    ...
    /** @hidden */
    _receive(event: MessageEvent): Promise<void>;
    /** @hidden */
    ...
    /**
     * View extensive documentation for this namespace [here](/api/classes/KnowledgeBaseNamespace)
     */
    kb: KnowledgeBaseNamespace;
    /**
     * View extensive documentation for this namespace [here](/api/classes/SchedulerNamespace)
     */
    scheduler: SchedulerNamespace;
    /**
     * View extensive documentation for this namespace [here](/api/classes/QueueNamespace)
     */
    queue: QueueNamespace;
    /**
     * View extensive documentation for this namespace [here](/api/classes/ReaderNamespace)
     */
