...
export declare const QueueEvent: {
    readonly QueueLoadCard: "queue.load-card";
...
export declare const AppEvents: {
    ...
    readonly setCustomCSS: "setCustomCSS";
};
/** @hidden */
export type AppEventKey = keyof typeof AppEvents;
/** @hidden */
export type AppEvent = typeof AppEvents[AppEventKey];
export type AppEventListerKey = string | undefined;
